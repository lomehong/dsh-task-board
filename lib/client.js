...
function BoardPage() {
  ...
  const [showCreate, setShowCreate2] = (0, import_react.useState)(false);
  ...
  const renderCard = (t, opts = {}) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { ...s.card, ...opts.archived === true ? s.cardArchived : {} }, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: s.cardActions, children: [
        ...
        opts.archived === true ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { style: s.btn2, onClick: () => void action("archive", { id: t.id, task: { archived: false } }), children: "\u6062\u590D" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { style: s.btn2, onClick: () => void action("archive", { id: t.id, task: { archived: true } }), children: "\u5F52\u6863" })
      ] })
    ] }, t.id);
  };
  const renderColumn = (col) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: s.col, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: s.colBody, children: list.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: s.empty, children: "\u6682\u65E0\u4EFB\u52A1" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
        ...
        settled && rest > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", { style: s.moreBtn, onClick: () => setSettledExpanded((prev) => ({ ...prev, [col]: true })), children: [
          "\u5C55\u5F00\u5176\u4F59 ",
          rest,
          " \u6761"
        ] })
            ...
            return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { style: s.td, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: s.cardActions, children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { style: s.btn2, onClick: () => void action("run", { id: t.id }), children: "\u25B6" }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { style: s.btn2, onClick: () => void action("archive", { id: t.id, task: { archived: !t.archived } }), children: t.archived === true ? "\u6062\u590D" : "\u5F52\u6863" })
                ] }) })
              ] }, t.id),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: s.wrap, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: s.actionRow, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { style: s.btn, onClick: () => setShowCreate2(true), children: "+ \u65B0\u5EFA\u4EFB\u52A1" }),
    ...
    showCreate && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CreateModal, { onClose: () => setShowCreate2(false), onCreated: () => {
...
function CreateModal({ onClose, onCreated }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: s.modal, onClick: () => setShowCreate && onClose(), children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: s.modalBox, onClick: (e) => e.stopPropagation(), children: [
...
function activate(context) {
  context.slots.register({
    name: "task-board",
    title: "\u4EFB\u52A1\u770B\u677F",
    render: () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BoardPage, {})
  });
}
